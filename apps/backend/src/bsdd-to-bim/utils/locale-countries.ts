export const getCountryByLocale = (locale: string) => {
	return (
		localeAndCountries.find((e) =>
			e.locales.split(",").some((e) => e.toLowerCase() === locale),
		) ?? { country: "", en_name: "", native_name: "", locales: "" }
	);
};
const localeAndCountries = [
	{
		country: "AD",
		en_name: "Andorra",
		native_name: "Andorra",

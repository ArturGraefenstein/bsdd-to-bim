...
/** @format int32 */
export enum InternalExternalOptionV1 {
  Value0 = 0,
  Value1 = 1,
  Value2 = 2,
}
...
export interface PropertyContractV5 {
  /** URI of the dictionary */
  dictionaryUri?: string | null;
  /**
   * Date of activation
  ...
  physicalQuantity?: string | null;
  /** List of allowed values */
  allowedValues?: PropertyValueContractV5[] | null;
  /** Indicates kind of value: Single, Range (2 values expected), List (multiple values expected), Complex (use in combination with "ConnectedProperties"), ComplexList */
  propertyValueKind?: string | null;
  /** List of relations with other properties */
  propertyRelations?: PropertyRelationContractV5[] | null;
  /** The text type, e.g. UTF-8 */
  textFormat?: string | null;
  /** Multiple references to Unit */
  units?: string[] | null;
...
export interface PropertyRelationContractV5 {
  /** Globally unique identification of the relation */
  uri?: string | null;
  /** The relation with the other property: e.g. HasReference, IsEqualTo */
  relationType?: string | null;
...
export interface PropertyValueContractV5 {
  /** Globally unique identification of the value */
  uri?: string | null;
  /** Identification of the value (unique within the property) */
  code?: string | null;
...
export interface UriRedirectionContractV1 {
...
export interface UriRedirectionsContractV1 {
  /** List of obsolete organization/dictionary codes which are mapped to new ones */
  uriRedirections?: UriRedirectionContractV1[] | null;
}
...
> extends HttpClient<SecurityDataType> {
  api = {
    ...
    classRelationsGet: (
      ...
      this.request<ClassRelationsContractV1, any>({
        path: `/api/Class/Relations/v1`,
        method: "GET",
        query: query,
        format: "json",
        ...params,
    ...
    classPropertiesGet: (
      ...
      this.request<ClassPropertiesContractV1, any>({
    ...
    dictionaryClassesGetWithClasses: (
      ...
      this.request<DictionaryClassesResponseContractV1Classes, any>({
 ...
 * @request GET:/api/DictionaryDownload/sketchup/v2
 * @secure
 */
    dictionaryDownloadSketchup: (
      query: {
        /**
      ...
      this.request<File, ProblemDetails | void>({
        path: `/api/DictionaryDownload/sketchup/v2`,
        method: "GET",
        query: query,
        secure: true,
        format: "json",
 ...
 *
 * @tags Dictionary
 * @name DictionaryDownloadGet
 * @summary Download file of dictionary.
...
If the dictionary does not exist, you get a "400 Bad request".
 * @request GET:/api/DictionaryDownload/bsdd/v1
 * @secure
 */
    dictionaryDownloadGet: (
      query: {
        /**
         * The uri of the dictionary to be downloaded, including version number, e.g. https://identifier.buildingsmart.org/uri/bs-agri/fruitvegs/1.1. You can replace the version number by "latest" to automatically get the latest (active) version of the dictionary.
         * If the dictionary does not exist, you will get a response "400 Bad request".
      ...
      this.request<File, ProblemDetails | void>({
        path: `/api/DictionaryDownload/bsdd/v1`,
        method: "GET",
        query: query,
        secure: true,
        format: "json",
 ...
 *
 * @tags Dictionary
 * @name DictionaryDownloadSketchup2
 * @summary Download a file with an export of a dictionary in format supported by Sketchup.
This API replaces /api/RequestExportFile/preview
 * @request POST:/api/DictionaryDownload/sketchup/v1
 * @originalName dictionaryDownloadSketchup
 * @duplicate
 * @secure
 */
    dictionaryDownloadSketchup2: (
      query: {
        /** The uri of the dictionary to be downloaded, including version number, e.g. https://identifier.buildingsmart.org/uri/bs-agri/fruitvegs/1.1. You can replace the version number by "latest" to automatically get the latest (active) version of the dictionary */
        DictionaryUri: string;
      },
 ...
 */
    uploadImportFilePost: (
      ...
      this.request<UploadImportFileResultV2, any>({
        path: `/api/UploadImportFile/v2`,
        method: "POST",
        body: data,
        secure: true,
     ...
     */
    popularDictionaryGet: (params: RequestParams = {}) =>
      this.request<PopularDictionariesResponseContractV1, any>({
        path: `/api/Dictionary/Popular/v1`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     * @secure
     */
    organizationManagePrivateAccessAdd: (
      organizationCode: string,
      dictionaryCode: string,
      data: PrivateDictionaryAccessContractV1,
      params: RequestParams = {},
    ) =>
      this.request<void, any>({
        path: `/api/Organization/v1/${organizationCode}/${dictionaryCode}/PrivateAccess`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     * @secure
     */
    organizationManagePrivateAccessDelete: (
      organizationCode: string,
      dictionaryCode: string,
      data: PrivateDictionaryAccessContractV1,
      params: RequestParams = {},
 ...
 */
    propertyGet: (
      ...
      this.request<PropertyContractV5, any>({
    ...
    propertyRelationsGet: (
      ...
      this.request<PropertyRelationsContractV1, any>({
        path: `/api/Property/Relations/v1`,
        method: "GET",
        query: query,
        format: "json",
        ...params,
    ...
    propertyClassesGet: (
      ...
      this.request<PropertyClassesContractV1, any>({
        path: `/api/Property/Classes/v1`,
        method: "GET",
        query: query,
        format: "json",
        ...params,
 ...
 */
    textSearchGet: (
      ...
      this.request<TextSearchResponseContractV2, any>({
 ...
 */
     ...
     *
     * @tags z Lookup data
     * @name UriRedirectionGet
     * @summary Get list of URI redirections
     * @request GET:/api/UriRedirection/v1
     */
    uriRedirectionGet: (params: RequestParams = {}) =>
      this.request<UriRedirectionsContractV1, any>({
        path: `/api/UriRedirection/v1`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     */
    referenceDocumentGet: (params: RequestParams = {}) =>
     ...
     */
    languageGet: (params: RequestParams = {}) =>
     ...
     */
    healthGet: (params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/api/Health`,
        method: "GET",
        ...params,
